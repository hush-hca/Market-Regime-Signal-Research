...
- [ ] Release: update collector/workflow, docs, full pytest suite, independent final review, commit/push, verify real GitHub ledger initialization and deployed English/Korean UI. Append actual evidence to execution ledger; no future performance claims while outcomes are pending.
